...
#   sbatch scripts/test.sh inference.phase=calib cp_output.save_pointwise_npz=true
#   sbatch scripts/test.sh inference.phase=test cp_output.save_pointwise_npz=true
