...
# CP workflow (datapipe only supports phase=val; point data.val.data_path at calib/test):
#   sbatch scripts/test.sh inference.phase=val data.val.data_path=data_splits/calib \
#       cp_output.save_pointwise_npz=true cp_output.subdir=cp_pointwise_calib
#   sbatch scripts/test.sh inference.phase=val data.val.data_path=data_splits/test \
#       cp_output.save_pointwise_npz=true cp_output.subdir=cp_pointwise_test
#   python cp_calibrate_and_write_vtp.py --calib-dir runs/<run_id>/cp_pointwise_calib \
#       --test-dir runs/<run_id>/cp_pointwise_test ...
